...
export default function Dashboard() {
    ...
    const purgeDuplicates = async () => {
        ...
        try {
            ...
            showToast(`Purge failed: ${message}`, 'error', '❌');
        } finally {
            setIsPurging(false);
        }
    };
                            ...
                            {activeTab === 'links' && (
                                <div className="bento-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                                    {user?.plan === 'free' && (
                                        <div className="bento-upgrade-banner">
                                            <div className="bento-upgrade-banner__text">
                                                ...
                                                <p>Get unlimited links, premium themes, and remove Linkszy branding.</p>
                                            </div>
                                    ...
                                    <header className="bento-page-header">
                                        ...
                                        <p>Manage the content on your Linkszy profile.</p>
                                    </header>
                                            ...
                                            <div className="promo-card__redeem">
                                                ...
                                                <div className="promo-row">
                                                    <input
                                                        ...
                                                        placeholder="e.g. LINKSZY_FRIENDS"
                                                        value={promoCode}
