            ...
            <div className="landing-page-content">
                ...
                <div style={{
                    ...
                    <div style={{ fontFamily: 'var(--font-body)', color: '#8a8aaa', fontSize: '0.9rem' }}>
                        <span style={{ fontWeight: 700, color: '#1e2d4a' }}>50,000+</span> creators already using Linkszy
                    </div>
                </div>
                ...
                <section className="sec-customize">
                    <div className="section-inner">
                        ...
                        <div className="cust-text">
                            ...
                            <p>Connect every piece of content you create across all platforms. Customize every detail to match your brand — or let Linkszy automatically build your perfect page.</p>
                ...
                <section className="share-section">
                    <div className="share-section__text">
                        ...
                        <h2>Share your Linkszy<br />everywhere.</h2>
                        <p>Add your unique Linkszy URL to every platform where your audience lives. One link works everywhere — your bio, QR code on merch, business cards, anywhere.</p>
