...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        setIsLoading(true);
        try {
            await signup(name, email, password, plan as 'free' | 'pro' | 'business');
    ...
    return (
        <div className="auth-root">
            <div className="auth-card">
                <Link to="/" className="auth-logo">Linkszy</Link>
            ...
            <div className="auth-brand-panel">
                <div className="auth-brand-logo-text">Links<span>zy</span></div>
